...
import { OperateResizeHandlers, ImageClipedEmitData } from '@/types/edit'
...
const ImageClipHandler: React.FC<ImageClipHandlerProps> = ({
  ...
  const [clipWrapperPositionStyle, setClipWrapperPositionStyle] = useState({ top: '0%', left: '0%' })
  ...
  }, [getClipDataTransformInfo, topImgWrapperPosition, width, height, onClip, updateRange])
